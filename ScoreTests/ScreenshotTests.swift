...
struct ScreenshotTests {
    ...
    private static func makeSubjects(in context: ModelContext) -> [Subject] {
        let definitions: [(String, String, Int, SubjectKind, [Int], Bool, Int?, Set<Int>)] = [
            ...
            ("Englisch", "E", 0x3E7CA6, .kernfach, [10, 11, 10, 12], false, nil, []),
            ("Geschichte", "G", 0xB4534A, .kernfach, [9, 10, 11, 9], false, nil, []),
            ("Gemeinschaftskunde", "GK", 0x7A6EA6, .kernfach, [8, 9, 8, 10], true, nil, []),
            ("Physik", "Ph", 0x40708C, .basisfach, [14, 13, 14, 15], false, nil, []),
            ("Chemie", "Ch", 0x5E8A72, .basisfach, [12, 13, 12, 13], false, nil, []),
            ("Geografie", "Geo", 0x5E8A72, .basisfach, [11, 6, 12, 5], false, 2, []),
            ("Sport", "S", 0xB4834A, .basisfach, [11, 12, 10, 4], false, nil, [3]),
            ("Bildende Kunst", "BK", 0xB4534A, .basisfach, [6, 5, 7, 6], true, nil, []),
            ("Religion", "Rel", 0x9A7B4F, .basisfach, [5, 4, 5, 6], false, nil, []),
            ("Musik", "Mu", 0x6E7AA6, .basisfach, [4, 3, 4, 5], false, nil, [])
        ]
