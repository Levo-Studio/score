...
struct SubjectDetailView: View {
    ...
    private var blockOneNote: some View {
        Text("Jede Leistung fließt mit ihrem Prozentwert in ihre Teilnote ein. Eingebracht werden 40 Kurse — hast du mehr, klammert Score von unten die schwächsten. Pflicht-Basisfächer bleiben immer drin, die Kurse deiner Prüfungsfächer ebenso.")
            .font(.optionMeta)
            .lineSpacing(5.5)
            .foregroundStyle(ScorePalette.inkSecondary)
