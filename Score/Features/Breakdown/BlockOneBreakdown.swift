...
struct BlockOneBreakdown {
    ...
    /// Die Basisfächer, an denen Score überhaupt klammern darf.
    ///
    ...
    /// Wie viele Basisfach-Ergebnisse überhaupt noch zur Klammerung anstehen.
    ...
    init(presentations: [SubjectPresentation]) {
        ...
        // Eingebrachte, das nicht aus einem klammerbaren Basisfach stammt.
        let protectedIncluded = entries
            .filter { !($0.kind == .basisfach && $0.allowsBracketing) }
