...
/// SwiftData bieten so etwas wie „jetzt abgleichen"; die Läufe hängen am Öffnen
...
final class ScoreDataStore {
    ...
    ///
    /// Das ist der eigentliche Anstoss hinter „Jetzt abgleichen": Ein frisch
    ...
    static func saveAndReopen() throws {
        let store = shared
