...
struct SubjectDetailView: View {
    ...
    private var blockOneNote: some View {
        Text("Jede Leistung fließt mit ihrem Prozentwert in ihre Teilnote ein. Block I fasst 42 Kurse — hast du mehr, klammert Score von unten die schwächsten. Kernfächer bleiben immer drin, die Kurse deiner Prüfungsfächer ebenso.")
            .font(.optionMeta)
            .lineSpacing(5.5)
            .foregroundStyle(ScorePalette.inkSecondary)
